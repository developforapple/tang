...
FOUNDATION_EXTERN NSString *const kYGStatusBarStyleBlackText;   //@"black" 对应 YGStatusBarStyleBlack
FOUNDATION_EXTERN NSString *const kYGStatusBarStyleLightText;   //@"light" 对应 YGStatusBarStyleLight
FOUNDATION_EXTERN NSString *const kYGStatusBarStyleWhiteText;   //@"white" 对应 YGStatusBarStyleLight
FOUNDATION_EXTERN NSString *const kYGStatusBarStyleAutoText;    //@"auto"  对应 YGStatusBarStyleAuto

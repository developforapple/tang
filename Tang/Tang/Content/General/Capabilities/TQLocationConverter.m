...
double get_distance(double lat1, double lng1, double lat2, double lng2)
{
    ...
    double _a = radLat1 - radLat2;
    double b = radian(lng1) - radian(lng2);
    
    double dst = 2 * asin((sqrt(pow(sin(_a / 2), 2) + cos(radLat1) * cos(radLat2) * pow(sin(b / 2), 2) )));
...
{
    return get_distance(coordinate1.latitude, coordinate1.longitude, coordinate2.latitude, coordinate2.longitude);
}

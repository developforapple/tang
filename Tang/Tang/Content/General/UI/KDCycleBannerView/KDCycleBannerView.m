...
#if __has_include(<YYWebImage/UIImageView+YYWebImage.h>)
                [imageView yy_setImageWithURL:[imageSource isKindOfClass:[NSString class]] ? [NSURL URLWithString:imageSource] : imageSource placeholder:placeHolderImage];
#else
...
#if __has_include(<YYWebImage/UIImageView+YYWebImage.h>)
                [imageView yy_setImageWithURL:[imageSource isKindOfClass:[NSString class]] ? [NSURL URLWithString:imageSource] : imageSource options:kNilOptions];
#else
